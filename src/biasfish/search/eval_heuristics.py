...
def initialize_table_set(table: list, value_table: list) -> list:
    """
    ...
    for piece_type, table in enumerate(table):
        ...
        new_table[piece_type] = [value_table[piece_type] + table_value for table_value in table]
...
BLACK_MG_PESTO_TABLE = [
    ...
    MG_BISHOP_TABLE, # chess.BISHOP = 3
    MG_ROOK_TABLE,   # chess.ROOK   = 4
    MG_QUEEN_TABLE,  # chess.QUEEN  = 5
    MG_KING_TABLE    # chess.KING   = 6
]

BLACK_EG_PESTO_TABLE = [
    None,
    EG_PAWN_TABLE,   # chess.PAWN   = 1
    EG_KNIGHT_TABLE, # chess.KNIGHT = 2
    EG_BISHOP_TABLE, # chess.BISHOP = 3
    EG_ROOK_TABLE,   # chess.ROOK   = 4
    EG_QUEEN_TABLE,  # chess.QUEEN  = 5
    EG_KING_TABLE    # chess.KING   = 6
]

BLACK_MG_PESTO_TABLE = initialize_table_set(BLACK_MG_PESTO_TABLE, MG_VALUE)
BLACK_EG_PESTO_TABLE = initialize_table_set(BLACK_EG_PESTO_TABLE, EG_VALUE)
WHITE_MG_PESTO_TABLE = [flip_vertical(table) for table in BLACK_MG_PESTO_TABLE]
WHITE_EG_PESTO_TABLE = [flip_vertical(table) for table in BLACK_EG_PESTO_TABLE]
